...
import 'package:hmapp/history_receiver.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
        ...
        child: Scaffold(
            ...
            body: TabBarView(
              children: [GiverHistory(), ReceiverHistory()],
            )));
  }
}

class GiverHistory extends StatefulWidget {
  @override
  _GiverHistoryState createState() => _GiverHistoryState();
}

class _GiverHistoryState extends State<GiverHistory> {
        ...
        builder: (BuildContext context,
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            if (snapshot.hasData) {
              ...
              return Center(
                child: Text("You have no giver History."),
              );
            }
          } else {
...
class GiverNotification extends StatefulWidget {
  ...
  @override
  _GiverHistorytate createState() => _GiverHistorytate();
}

class _GiverHistorytate extends State<GiverNotification> {
  String? url;
