...
class ReceiverHistory extends StatefulWidget {
  @override
  _ReceiverHistoryState createState() => _ReceiverHistoryState();
}

class _ReceiverHistoryState extends State<ReceiverHistory> {
        ...
        builder: (BuildContext context,
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            if (snapshot.hasData) {
              ...
              return Center(
                child: Text("You have no receiver history."),
              );
            }
          } else {
...
class ReceiverNotification extends StatefulWidget {
  ...
  @override
  _ReceiverHistorytate createState() => _ReceiverHistorytate();
}

class _ReceiverHistorytate extends State<ReceiverNotification> {
  String? url;
